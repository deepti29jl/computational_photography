...
def get_equirectangular_image(reflection_vector, hdr_image, phi_3=True):
    '''
    ...
    return equirectangular_image.astype(np.float32), phi_ball, theta_ball, equirectangular_coord
